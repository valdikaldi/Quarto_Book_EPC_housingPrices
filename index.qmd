...
::: paratext
On this site, I present my empirical project, conducted as part of my Master's thesis in Applied Economics and Data Science. 
In this project, I attempt to determine whether homebuyers in Denmark value energy efficiency and specific energy-related features in properties.

In particular, I explore whether homebuyers are willing to pay a premium for energy-efficient properties or, conversely, accept a discount for properties that are less energy-efficient. 
To quantify energy efficiency both the energy label or EPC label (i.e. the label stated in the Energy Performance Certificate of each property) and estimated energy consumption in kWh was utilized.
